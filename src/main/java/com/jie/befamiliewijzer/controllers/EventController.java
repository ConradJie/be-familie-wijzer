...
public class EventController {
    ...
    @GetMapping("/events/month/{month}/day/{day}")
    public ResponseEntity<List<EventMonthDayDto>> getAllgetAllCelebrateEventsOnMonthDayEventsOnMonthDay(@PathVariable Integer month, @PathVariable Integer day) {
        return ResponseEntity.ok(eventService.getAllCelebrateEventsOnMonthDay(month, day));
    }
